  ...
  <section className="w-screen bg-[#fff8e9] py-20 px-6 md:px-16">
    <div className="max-w-6xl mx-auto text-center">
      ...
      <p className="text-gray-700 max-w-3xl mx-auto mb-12 text-lg">
        ...
        <strong>aprendizaje significativo</strong>, donde los estudiantes comprenden los fundamentos
        detrás de cada concepto, desarrollan pensamiento lógico y fortalecen la confianza en sí
        mismos. Aquí podrás descargar materiales que usamos en nuestras clases o guías de apoyo para
        que no tengas que solicitarlos por correo.
      </p>
